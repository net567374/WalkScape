  ...
  const handleRegisterPlayer = async () => {
    ...
    try {
      ...
      const contractTyped = (contract as unknown) as {
        registeredPlayers: (address: string) => Promise<boolean>;
      };
      ...
      const contractWithSignerTyped = (contractWithSigner as unknown) as {
      ...
      <div className="flex flex-col items-center justify-center p-8 text-center">
        <div className="mb-6">
          ...
          <p className="text-gray-400 max-w-md">
            Connect your wallet to start exploring, collecting artifacts, and
      ...
      <div className="flex flex-col items-center justify-center p-8 text-center">
        <div className="mb-6">
          ...
          <p className="text-gray-400">
            Your wallet is connected and you&apos;re registered to play
            WalkScape.
          </p>
          <p className="text-sm text-gray-500 mt-2">
    ...
    return (
      <div className="flex flex-col items-center justify-center p-8 text-center">
        <div className="mb-6">
          ...
          <p className="text-gray-400 max-w-md">
            One more step! Register on the blockchain to start your WalkScape
            adventure.
          </p>
          <p className="text-sm text-gray-500 mt-2">
            Connected: {address?.slice(0, 6)}...{address?.slice(-4)}
        ...
        <div className="mt-8 text-sm text-gray-500 max-w-md">
          <p>
            Registration requires a small gas fee to store your player data on
            the blockchain.
          </p>
        </div>
      </div>
